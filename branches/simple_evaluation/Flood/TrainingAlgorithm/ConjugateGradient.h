...
public:
   ...
   /// Enumeration of the available training operators for obtaining the train direction.

   enum TrainDirectionMethod{PolakRibiere, FletcherReeves};
...
private: 
   ...
   /// Initial train rate in first epoch for line minimization.
   ...
   /// Variable containing the actual method used to obtain the conjugate gradient train direction.

   TrainDirectionMethod trainDirectionMethod;
   ...
   // Train direction methods

   double calculatePolakRibiereParameter(Vector<double>, Vector<double>);
   double calculateFletcherReevesParameter(Vector<double>, Vector<double>);

   Vector<double> calculateFletcherReevesTrainDirection(Vector<double>, Vector<double>, Vector<double>);
   Vector<double> calculatePolakRibiereTrainDirection(Vector<double>, Vector<double>, Vector<double>);
...
public:
   ...
   TrainDirectionMethod getTrainDirectionMethod(void);
   ...
   void setTrainDirectionMethod(TrainDirectionMethod);
