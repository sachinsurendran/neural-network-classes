...
/// Training operators:
/// <ul>
/// <li> Inverse Hessian approximation method = BFGS;
/// <li> Train rate method = Brent method;
/// </ul>
///
/// Training parameters:
/// <ul>
...
QuasiNewtonMethod::QuasiNewtonMethod(ObjectiveFunctional* newObjectiveFunctional)
: TrainingAlgorithm(newObjectiveFunctional)
{
   // Inverse Hessian approximation method

   inverseHessianApproximationMethod = BFGS;
...
// InverseHessianApproximationMethod getInverseHessianApproximationMethod(void) method

QuasiNewtonMethod::InverseHessianApproximationMethod QuasiNewtonMethod::getInverseHessianApproximationMethod(void)
{
   return(inverseHessianApproximationMethod);
}
...
QuasiNewtonMethod::TrainRateMethod QuasiNewtonMethod::getTrainRateMethod(void)
{
...
double QuasiNewtonMethod::getFirstTrainRate(void)
{
...
double QuasiNewtonMethod::getBracketingFactor(void)
{
...
double QuasiNewtonMethod::getTrainRateTolerance(void)
{
...
double QuasiNewtonMethod::getWarningTrainRate(void)
{
...
double QuasiNewtonMethod::getErrorTrainRate(void)
{
...
bool QuasiNewtonMethod::getReserveTrainingDirectionHistory(void)
{
...
bool QuasiNewtonMethod::getReserveTrainingDirectionNormHistory(void)
{
   return(reserveTrainingDirectionHistory);     
}
...
bool QuasiNewtonMethod::getReserveTrainingRateHistory(void)
{
...
Matrix<double> QuasiNewtonMethod::getTrainingDirectionHistory(void)
{
...
Vector<double> QuasiNewtonMethod::getTrainingDirectionNormHistory(void)
{
...
Vector<double> QuasiNewtonMethod::getTrainingRateHistory(void)
{
   return(trainingRateHistory);               
}


// void setInverseHessianApproximationMethod(InverseHessianApproximationMethod) method

/// This method sets a new inverse Hessian approximatation method value. 
///
/// @param newInverseHessianApproximationMethod Inverse Hessian approximation method value.

void QuasiNewtonMethod::setInverseHessianApproximationMethod(QuasiNewtonMethod::InverseHessianApproximationMethod 
newInverseHessianApproximationMethod)
{
   inverseHessianApproximationMethod = newInverseHessianApproximationMethod;
}
...
void QuasiNewtonMethod::setTrainRateMethod(QuasiNewtonMethod::TrainRateMethod newTrainRateMethod)
{
...
/// This method sets a new initial train rate value to be used for line minimization.
///
...
void QuasiNewtonMethod::setFirstTrainRate(double newFirstTrainRate)
{ 
   ...
   {
      std::cerr << std::endl
                << "Flood Error: QuasiNewtonMethod class." << std::endl
                << "void setFirstTrainRate(double) method." << std::endl
                << "Initial train rate must be greater than 0." << std::endl
                << std::endl;
...
/// This method sets a new increase factor value to be used for line minimization 
/// when bracketing a minimum.
///
...
void QuasiNewtonMethod::setBracketingFactor(double newBracketingFactor)
{ 
   // Control sentence (if debug)
...
/// This method sets a new tolerance value to be used for line minimization.
///
...
void QuasiNewtonMethod::setTrainRateTolerance(double newTrainRateTolerance)
{
   // Control sentence (if debug)
...
void QuasiNewtonMethod::setWarningTrainRate(double newWarningTrainRate)
{
   // Control sentence (if debug)
...
void QuasiNewtonMethod::setErrorTrainRate(double newErrorTrainRate)
{
   // Control sentence (if debug)
...
void QuasiNewtonMethod::setReserveTrainingDirectionHistory(bool newReserveTrainingDirectionHistory)
{
...
void QuasiNewtonMethod::setReserveTrainingDirectionNormHistory(bool newReserveTrainingDirectionNormHistory)
{
...
void QuasiNewtonMethod::setReserveTrainingRateHistory(bool newReserveTrainingRateHistory)
{
...
void QuasiNewtonMethod::setReserveAllTrainingHistory(bool newReserveAllTrainingHistory)
{
...
void QuasiNewtonMethod::setTrainingDirectionHistory(Matrix<double> newTrainingDirectionHistory)
{
...
void QuasiNewtonMethod::setTrainingDirectionNormHistory(Vector<double> newTrainingDirectionNormHistory)
{
...
void QuasiNewtonMethod::setTrainingRateHistory(Vector<double> newTrainingRateHistory)
{
...
double QuasiNewtonMethod::calculateGoldenSectionTrainRate(double initialTrainRate, double evaluation,
Vector<double> freeParameters, Vector<double> trainDirection)
{
   ...
   double oldB = b;
   double oldEvaluationB = evaluationB;   

   while(evaluationA > evaluationB)
   {
      // Reset a point and corresponding evaluation 

      if(b != initialTrainRate)
      {
         a = oldB;
         evaluationA = oldEvaluationB;
      }      
   ...
   evaluationD = objectiveFunctional
...
// double calculateBrentMethodTrainRate(double, double, Vector<double>, Vector<double>) method
...
double QuasiNewtonMethod::calculateBrentMethodTrainRate(double initialTrainRate, double evaluation,
Vector<double> freeParameters, Vector<double> trainDirection)
{
   double trainRate = 0.0;
   ...
   while(evaluationA >= evaluationB)
   {
      ...
      if(b >= errorTrainRate)
      {
         std::cerr << std::endl
                   << "Flood Error: QuasiNewtonMethod class." << std::endl
                   << "double calculateBrentMethodTrainRate"
                   << "(double, double, Vector<double>, Vector<double>) method." << std::endl
                   << "Unable to bracket a minimum." << std::endl;
...
void QuasiNewtonMethod::train(void)
{
   ...
   {
      std::cout << std::endl
                << "Flood Warning: Gradient norm is " << gradientNorm << "." << std::endl;          
   }
   ...
   {  
      ...
      {        
         std::cout << std::endl;
         std::cout << "Initial gradient norm is less than goal." << std::endl;
   ...
   // Initial objective function hessian
   ...
   for(int i = 0; i < numberOfFreeParameters; i++)
   {
      ...
      {   
         if(i == j)
         {
            inverseHessianApproximation[i][j] = 1.0;     
         }
      }                           
   }                   

   // Train direction stuff

   Vector<double> trainDirection(numberOfFreeParameters);
   Vector<double> oldFreeParameters(numberOfFreeParameters);
   Vector<double> oldGradient(numberOfFreeParameters);
   Matrix<double> oldInverseHessianApproximation(numberOfFreeParameters, numberOfFreeParameters);
   double slope = 0.0;
   ...
   for(int epoch = 1; epoch <= maximumNumberOfEpochs; epoch++)
   {
      ...
      trainDirection = inverseHessianApproximation*gradient*(-1.0);      
      ...
      if(slope >= 0.0)
      {
         ...
         //{
         //   std::cout << std::endl
         //             << "Function slope is equal or greater than zero."
         //             << std::endl
         //             << "Train direction reset to negative gradient."
         //             << std::endl;
         //}
      ...
      switch(trainRateMethod)
      {
         ...
         case GoldenSection:
            ...
            trainRate 
			= calculateGoldenSectionTrainRate(initialTrainRate, evaluation, freeParameters, trainDirection);
         ...
         case BrentMethod:
            ...
            trainRate 
            = calculateBrentMethodTrainRate(initialTrainRate, evaluation, freeParameters, trainDirection);
      ...
      if(trainRate == 0.0)
      {
         ...
         else
         {
            ...
            //{
            //   std::cout << std::endl
            //             << "Train rate is zero for a quasi-Newton train direction."
            //             << std::endl
            ...
            switch(trainRateMethod)
            {
               ...
               case GoldenSection:
                  ...
                  (firstTrainRate, evaluation, freeParameters, trainDirection);
      ...
      oldFreeParameters = freeParameters;
      ...
      {
         std::cout << std::endl
                   << "Flood Warning: Free parameters norm is " << freeParametersNorm << "." << std::endl;          
      }
      ...
      // Objective function Hessian approximation

      oldInverseHessianApproximation = inverseHessianApproximation;

      switch(inverseHessianApproximationMethod)
      {
         case DFP:
	     {
            inverseHessianApproximation 
            = objectiveFunctional->calculateDFPInverseHessianApproximation
            (oldFreeParameters, oldGradient, oldInverseHessianApproximation, 
            freeParameters, gradient);
		 }//end dfp
	     ...
	     {
            inverseHessianApproximation 
            = objectiveFunctional->calculateBFGSInverseHessianApproximation
            (oldFreeParameters, oldGradient, oldInverseHessianApproximation, 
            freeParameters, gradient);
		 }//end bfgs
...
/// This method prints to the screen the train direction and 
/// the operators chosen for training, the training parameters, 
/// the stopping criteria and other user stuff concerning the quasi-Newton
/// method object:
///
/// Training operators:
/// <ul>
/// <li> Inverse hessian approximation method.
...
void QuasiNewtonMethod::print(void)
{
   std::cout << std::endl
             << "Quasi-Newton Method Object." << std::endl; 

   // Training operators

   // Inverse Hessian approximation method

   std::cout << "Inverse Hessian approximation method:" << std::endl;

   if(inverseHessianApproximationMethod == DFP)
   {
      std::cout << "DFP" << std::endl;
   }
   else if(inverseHessianApproximationMethod == BFGS)
   {
   ...
   if(trainRateMethod == Fixed)
   {
      std::cout << "Fixed" << std::endl;
   }
   else if(trainRateMethod == GoldenSection)
   {
      std::cout << "Golden section" << std::endl;
   }
   else if(trainRateMethod == BrentMethod)
   {
...
/// This method saves the quasi-Newton Method object to a data file. 
///
/// Training operators:
/// <ul>
/// <li> Inverse Hessian approximation method.
...
void QuasiNewtonMethod::save(char* filename)
{
   // File
   ...
   if(!file.is_open())
   {
      std::cerr << std::endl 
                ...
                << "Cannot open quasi-Newton method object data file."  << std::endl
                << std::endl;
   ...
   else
   {
      ...
      {
         std::cout << std::endl
                   << "Saving quasi-Newton method object to data file..." << std::endl;
      }
   }

   // Write file header

   file << "% Flood Neural Network. Quasi-Newton Method Object." << std::endl;

   // Training operators

   // Fitness assingment method

   file << "InverseHessianApproximationMethod:" << std::endl;
...
/// This method loads a quasi-Newton method object from a data file. 
/// Please mind about the file format, wich is specified in the User's Guide. 
///
/// Training operators:
/// <ul>
/// <li> Inverse Hessian approximation method.
/// <li> Ttrain rate method.
/// </ul>
///
/// Training parameters:
/// <ul>
...
void QuasiNewtonMethod::load(char* filename)
{
   // File
   ...
   else
   {
      ...
      {
         std::cout << std::endl
                   << "Loading quasi-Newton method object from data file..."  
                   << std::endl;
      }
   }
   ...
   while(word != "InverseHessianApproximationMethod:")
   {
      file >> word;
   }
   ...
   if(word == "DFP")
   {
      inverseHessianApproximationMethod = DFP;
   }
   else if(word == "BFGS")
   {
      inverseHessianApproximationMethod = BFGS;
...
void QuasiNewtonMethod::resizeTrainingHistory(int newSize)
{
...
void QuasiNewtonMethod::saveTrainingHistory(char* filename)

{
   ...
   file << "% Flood Neural Network. Quasi-Newton Method Training History." << std::endl;
