...
class IntegrationOfFunctions 
{
   ...
   double calculateTrapezoidIntegral(double (*f)(double), double, double, int);
   double calculateSimpsonIntegral(double (*f)(double), double, double, int);
   
   // Integration of pairs of data (x,y)

   double calculateTrapezoidIntegral(Vector<double>, Vector<double>);
   double calculateSimpsonIntegral(Vector<double>, Vector<double>);

   // Integration of class member methods

   // template<class T> double calculateTrapezoidIntegral(
   ...
   template<class T> 
   double calculateTrapezoidIntegral(T t, double (T::*f)(double), double a, double b, int n)
   {
      ...
      trapezoidIntegral = h*sum;

      return(trapezoidIntegral);
   }


   // template<class T> double calculateSimpsonIntegral(
   // T t, double (T::*f)(double), double a, double b, int n) method
   ...
   template<class T> 
   double calculateSimpsonIntegral(T t, double (T::*f)(double), double a, double b, int n)
   {
